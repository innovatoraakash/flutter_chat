...
import 'package:goWisper/frontend/call_screens/video_calling.dart';
...
import 'package:goWisper/frontend/call_screens/call_screen.dart';
...
import 'package:goWisper/models/previous_message.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _checkingForIncomingMessages(Map<String, dynamic>? docs) async {
    ...
    if ((getIncomingMessages != null) && (getIncomingMessages != lastMsg)) {
