...
import 'package:goWisper/backend/firebase/auth/email_and_password_auth.dart';
import 'package:goWisper/backend/firebase/auth/google_auth.dart';
import 'package:goWisper/backend/firebase/online_database_management/cloud_data_management.dart';
import 'package:goWisper/frontend/main_screens/main_screen.dart';
import 'package:goWisper/frontend/new_user_entry_screen/new_user_entry.dart';
import 'package:goWisper/global_uses/constants.dart';
import 'package:goWisper/frontend/auth_screens/sign_up.dart';
import 'package:goWisper/global_uses/enum_generation.dart';
import 'package:goWisper/global_uses/reg_exp.dart';
import 'package:goWisper/global_uses/alert.dart';
          ...
          child: Padding(
            ...
            child: ListView(shrinkWrap: true, children: <Widget>[
              ...
              InkWell(
                  onTap: () {
                    if (_email.text != null) {
                      EmailAndPasswordAuth().recoverPassword(_email.text);
                    }
                  },
