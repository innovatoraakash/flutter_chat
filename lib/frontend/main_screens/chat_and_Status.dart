...
import 'package:goWisper/backend/firebase/online_database_management/cloud_data_management.dart';
import 'package:goWisper/backend/sqlite_management/local_database_management.dart';
import 'package:goWisper/frontend/call_screens/pickup_screen.dart';
import 'package:goWisper/frontend/preview/image_preview.dart';
import 'package:goWisper/frontend/status_screens/story_view.dart';
import 'package:goWisper/models/call.dart';
import 'package:goWisper/models/story_model.dart';
import 'package:goWisper/services/chat_management/chat_screen.dart';
import 'package:goWisper/frontend/status_screens/status_maker.dart';
import 'package:goWisper/global_uses/constants.dart';
import 'package:goWisper/global_uses/enum_generation.dart';
import 'package:goWisper/models/latest_message_from_connection.dart';
import 'package:goWisper/services/search_screen.dart';
...
class _ChatAndStatusScreenState extends State<ChatAndStatusScreen> {
  ...
  Future<void> _checkingForMessagesAndStatus(
    ...
    try {
      ...
      print(
          'error in getting last sent message and status from firestore ${e.toString()}');
    }
  }
